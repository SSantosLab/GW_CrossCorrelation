...
# coding: utf-8
# This python file is used for PreProcessing in the 'RunGWEvents_Final.py'. Given just the files for the GW Event and
...
def runPreProcessing(gw_file, cat_file, nest = False):
    ...
    return [z_gal, lumd_pdf, weights_pdf, cat_ra, cat_dec, prob, NSIDE, GW_event_ID, m, gw_distances, distsigma,distnorm, completeness]
